...
public class SwingComponent_09 extends JFrame {
	...
	Icon icon1 = new ImageIcon("C:\\sist0103\\image\\swingimage\\brown-line.gif");
	...
	public void initDesign() {
		...
		lbl2 = new JLabel("안녕히가세요", icon1, JLabel.LEFT);
		...
		SimpleDateFormat sdf = new SimpleDateFormat("yyy년 MM월 dd일 HH시 mm분");
		
		lbl4 = new JLabel(sdf.format(new Date()),icon1,JLabel.CENTER);
		lbl4.setBounds(10, 210, 200, 30);
		lbl4.setBorder(new LineBorder(Color.pink,2)); // 색상, 선 굵기
		this.add(lbl4);
	...
	public static void main(String[] args) {
		...
		new SwingComponent_09("스윙컴포넌트_09");
