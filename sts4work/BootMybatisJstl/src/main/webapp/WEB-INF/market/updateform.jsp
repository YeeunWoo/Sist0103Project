		...
		<input type="hidden" name="num" value="${dto.num }">
			<table class="table table-bordered">
				<tr>
					...
					<td>
						<input type="text" name="sang" value="${dto.sang }"class="form-control" required="required">
					</td>
				</tr>
				<tr>
					<th class="table-light">단가</th>
					<td>
						<input type="text" name="dan" value="${dto.dan }"class="form-control" required="required">
					</td>
				</tr>
				<tr>
