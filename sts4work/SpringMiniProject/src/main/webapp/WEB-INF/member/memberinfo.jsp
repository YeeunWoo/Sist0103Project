				...
				<c:if
					...
					<tr>
						<td style="width: 250px;" align="center" rowspan="5"><img
							alt="" src="../memberphoto/${dto.photo }" width="200"
							height="220" border="1"> <br> <br> <input
							type="file" id="newphoto" num="${dto.num }"
							style="display: none;">
							<button type="button" class="btn btn-info btnnewphoto">사진수정</button>
						</td>
						<td>회원명: ${dto.name }</td>
						<td rowspan="5" align="center" style="width: 200px;"
							valign="middle">
							<button type="button" class="btn btn-outline-info btnupdate"
								num="${dto.num }" data-bs-toggle="modal"
								data-bs-target="#myUpdateModal">수정</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="d-inline-flex">
						<label style="width: 80px;">Name: </label>&nbsp;&nbsp; <input
							type="text" class="form-control" id="updatename">
					</div>
					<div class="d-inline-flex">
						<label style="width: 80px;">hp: </label>&nbsp;&nbsp; <input
							type="text" class="form-control" id="updatehp">
					</div>
					<div class="d-inline-flex">
						<label style="width: 80px;">email: </label>&nbsp;&nbsp; <input
							type="text" class="form-control" id="updateemail">
					</div>
					<div class="d-inline-flex">
						<label style="width: 80px;">addr: </label>&nbsp;&nbsp; <input
