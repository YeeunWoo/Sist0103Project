...
<body>
	<div style="margin: 100px auto; width: 800px; text-align: center;">
		<form action="insert" method="post" enctype="multipart/form-data"
			...
			<table class="table table-bordered">
				...
				<tr>
					<td style="" center" rowspan="5"><input type="file"
						name="myphoto" id="myphoto" style="display: none;">
						<button type="button" id="btnphoto" class="btn btn-secondary">사진선택</button>
						<br> <img id="showimg"></td>
					<td>
				...
				<tr>
					<td>
						<div class="d-inline-flex">
							<input type="password" style="width: 120px;" name="pass"
								id="pass" placeholder="숫자4자리" class="form-control"
								required="required">&nbsp; <input type="password"
								style="width: 120px;" id="pass2" placeholder="비밀번호확인"
								class="form-control" required="required"> &nbsp; <span
								class="passsuccess" style="width: 60px; color: green;"></span>
						</div>
					</td>
				</tr>
				<tr>
					<td><input type="text" name="name" class="form-control"
						style="width: 150px;" placeholder="이름입력" required="required">
					</td>
				</tr>
				<tr>
					<td><input type="email" name="email" class="form-control"
						style="width: 240px;" placeholder="이메일입력" required="required">
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="d-inline-flex">
							...
							&nbsp; &nbsp; <input type="text" name="addr"
								placeholder="주소를 입력하세요" style="width: 300px;"
