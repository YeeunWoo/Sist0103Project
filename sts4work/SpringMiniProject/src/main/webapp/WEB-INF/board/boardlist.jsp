			...
			<c:if test="${totalCount>0 }">
				<c:forEach var="a" items="${list }">
					<tr>
						...
						<td><a
							href="content?num=${a.num }&currentPage=${currentPage}"
							style="color: black;"> ${a.subject } </a> <c:if
								test="${a.uploadfile!='no' }">
	...
	<div style="margin: 100px 100px; width: 1000px; text-align: center;">
		<ul class="pagination justify-content-center">
			...
			<c:if test="${endPage<totalPage }">
				<li class="page-item"><a class="page-link"
					href="list?currentPage=${endPage+1 }" style="color: black;">다음</a>
				</li>
			</c:if>
		</ul>
	</div>
