		...
		<form action="shop/addaction.jsp" method="post" enctype="multipart/form-data">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						<select style="width:200px;" class="form-control" required="required" name="category">
							...
							<option value="아우터">상의</option>
							<option value="아우터">하의</option>
							<option value="아우터">셋업</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="sangpum" class="form-control" style="width:200px;" required="required" placeholder="상품명입력">
					</td>
				</tr>
				<tr>
					<td style="width:150px;" class="table-light">
				...
				<tr>
					...
					<td>
						<input type="text" name="price" class="form-control" style="width:200px;" required="required" placeholder="가격입력">
					</td>
				</tr>
				<tr>
					<td style="width:150px;" class="table-light">
