	...
	<form action="addaction.jsp" method="post" enctype="multipart/form-data">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<input type="text" name="pass" class="form-control" style="width: 300px;" required="required">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<textarea style="width: 280px; height:100px;" class="form-control" name="content" required="required"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
				<button type="submit" style="width: 100px;" class="btn btn-success btn-md">저장하기</button>
				<button type="submit" style="width: 100px;" class="btn btn-warning btn-md" onclick="location.href='boardlist.jsp'">목록</button>
				</td>
			</tr>
		</table>
	</form>
