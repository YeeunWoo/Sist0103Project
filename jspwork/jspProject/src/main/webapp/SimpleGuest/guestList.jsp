...
<body>
	<div style="margin: 50px 100px; width: 600px">
		...
		%>
		<div class="edit">
			<i class="bi bi-pencil-square" onclick="location.href='updateForm.jsp?num=<%=dto.getNum()%>'"></i> <i
				class="bi bi-trash3" onclick="location.href=''"></i>
		</div>
		...
		<table class="table table-bordered" style="width: 600px;">
			...
			<tr>
				<td style="width: 400px;"><img
					src="../image/avata/b<%=dto.getImage()%>.png" align="left"
					hspace="20"> <pre><%=dto.getContent()%></pre></td>
			</tr>
		</table>
