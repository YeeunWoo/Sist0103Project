...
<head>
<meta charset="UTF-8">
<link href="https:/ delivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
		...
		<table class="table table-bordered" style="width: 550px;">
			...
			<tr>
				<td colspan="4" align="center">
					...
					<input type="button" value="방명록" class="btn btn-outline-success" onclick="location.href'guestList.jsp'">
				</td>
			</tr>
