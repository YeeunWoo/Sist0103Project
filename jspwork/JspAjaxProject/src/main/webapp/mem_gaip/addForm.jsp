...
<script type="text/javascript">
	function openId(){
		window.open("idSearch.jsp", "idcheck", "left=" + (screen.width - 400) / 2 + ",top=" + (screen.height - 300) / 2 + ",width=400,height=300");
	}
	...
	$(function(){
		$("#btnsubmit").click(function(){
			if(mfrm.m_id.value.length==0){
				...
				return false; //form action 호출 안 됨
			}
		});
	});
</script>
	...
	<div style="margin: 50px 100px; width: 500px;">
		<form action="addMember.jsp" method="post" enctype="multipart/form-data" name="mfrm">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						<div class="d-inline-flex">
							...
							<button type="button" class="btn btn-danger btn-sm" style="margin-left: 20px;" onclick="openId()">아이디입력</button>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center"><button type="submit" class="btn btn-info" id="btnsubmit">회원가입신청</button></td>
				</tr>
			</table>
		</form>
	</div>
