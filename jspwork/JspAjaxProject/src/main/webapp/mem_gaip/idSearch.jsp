...
<body>
	<%
	String key = request.getParameter("key"); //처음 호출 시 null값
	if (key == null) { //null값일 때는 form 출력
	%>
	...
	<div style="margin: 50px 50px;">
		<h5><%=m_id %>이미 가입된 아이디입니다</h5>
		<img src="../image/jquery_img/image_01.png" width="60" align="left">
	...
	%>
		<div style="margin: 50px 50px;">
			...
			<img src="../image/jquery_img/image_03.png" width="60" align="left">
